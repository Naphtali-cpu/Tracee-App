...
import com.example.tracee2.MyRestaurantsArrayAdapter;
import com.example.tracee2.MyRestaurantsArrayAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener(){
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                Toast.makeText(LocationActivity.this, restaurant, Toast.LENGTH_LONG).show();
            }
        });
            ...
            public void onResponse(Call<YelpBusinessesSearchResponse> call, Response<YelpBusinessesSearchResponse> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    ArrayAdapter adapter
                            = new MyRestaurantsArrayAdapter(LocationActivity.this, android.R.layout.simple_list_item_1, restaurants, categories);
