...
public class Travel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url = "https://images.pexels.com/photos/7119031/pexels-photo-7119031.jpeg?auto=compress&cs=tinysrgb&h=750&w=1260";
        ...
        mHiking.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Travel.this, Dashboard.class);
